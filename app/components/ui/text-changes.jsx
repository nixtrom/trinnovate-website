...
export function TextChanges({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative inline-block rounded-lg pt-2 pb-3 text-center text-4xl font-bold text-black md:text-5xl dark:text-[#0f0f0f]",
        ...
        "dark:[background:linear-gradient(to_bottom_right,var(--color-neutral-200),var(--color-neutral-300))]",
        "dark:shadow-md dark:shadow-neutral-300/30",
        className
      )}
