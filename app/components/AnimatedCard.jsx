...
const Skeleton = () => {
  ...
  return (
    <div className="overflow-hidden h-full relative flex items-center justify-center">
      ...
      <div className="h-40 w-[2px] absolute  m-auto z-40 bg-gradient-to-b from-transparent via-red-500 to-transparent animate-move">
...
export const Card = ({ className, children }) => {
  return (
    <div
      className={cn(
        "max-w-sm h-full w-full mx-auto  rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-transparent bg-gray-100 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
        className
      )}
    >
      {children}
...
export const CardSkeletonContainer = ({
  ...
  return (
    <div
      className={cn(
        "h-full md:h-full rounded-xl z-40",
        className,
        showGradient &&
